...
The bags of Red box contain and respectively, those of Green box contain
and , and those of Blue contain and . A box is chosen at random in such
a way that
...
\protect\hyperlink{sectionCompoundDistribution}{2}.

\textbf{Note} The compound negative binomial distribution is an appropriate
