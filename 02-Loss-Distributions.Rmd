...
```{r FittedExpGamma, tut = FALSE, fig.cap= 'The probability density functions (pdf) of gamma distributions with various shape alpha and rate parameter lambda = 1.', echo = FALSE, warning= FALSE}
...
ggplot(dat) + geom_histogram(aes(x = claims, y = ..density..), bins = 90 , fill = "grey", color = "black") + stat_function(fun=dexp, geom ="line", args = (rate = 1/mean(dat$claims)), aes(colour = "Exp")) + 
